...
const PLANS = [
  ...
  },
  {
    ...
    price: '$15',
    period: 'per month',
    features: ['25 products', '10 competitors per product', 'Daily price checks', 'Email alerts', 'Price history charts', 'Auto price adjust'],
    cta: 'Upgrade to Pro',
    highlight: true,
  },
  {
    ...
    price: '$39',
    period: 'per month',
    features: ['Unlimited products', 'Unlimited competitors', 'Daily price checks', 'Email + Slack alerts', 'Price history charts', 'Auto price adjust', 'Priority support'],
